...
public class Charmander extends Pokemon implements FireType {
	 ...
	 * This allows subclass specific name, number, height, 
    * weight, and basePowers to pass through to Pokemon 
    ...
    *@param type2 The secondary type of this Pokemon.
	...
	public String performFastAttack(Pokemon victim) {
		...
		if (fastIsFire || type2.equals("")) { 
			//if attack is fire-type
			if (vType.equals("Grass") || vType.equals("Ice") 
					|| vType.equals("Bug") || vType.equals("Steel")) {

				s = s + "\n It was super effective!";
				modifier = modifier * 2.0;          
			} else if (vType.equals("Fire")  
					|| vType.equals("Water") || vType.equals("Rock") 
					|| vType.equals("Dragon")) { 
	...
	public String performSpecialAttack(Pokemon victim) {
		...
		if (vType.equals("Grass") || vType.equals("Ice") || vType.equals("Steel")
				|| vType.equals("Bug")) {
