...
public abstract class Pokemon implements Comparable<Pokemon> {
   ...
   **/
   public Pokemon(String species, String name, 
	   ...
	   if (name == "") {
		   throw new PokemonException("Name can't be blank!");
	   }
   ...
   */
   ...
   /**
    * Compares one Pokemon to another
    */
   public int compareTo(Pokemon otherPokemon) {
	   if(this.equals(otherPokemon)) {
		   return 0;
	   }
	   
	   /* number */
	   if(this.getNumber() != otherPokemon.getNumber()) {
		   return this.getNumber() - otherPokemon.getNumber();
	   }
	   
	   /* name */
	   if(this.getName() != otherPokemon.getName()) {
		   return this.getName().compareTo(otherPokemon.getName());
	   }
	   
	   /* hP */
	   if(this.getHP() != otherPokemon.getHP()) {
		   return this.getHP() - otherPokemon.getHP();
	   }   
	   
	   /* cP */
	   if(this.getCP() != otherPokemon.getCP()) {
		   return this.getCP() - otherPokemon.getCP();
	   }
	   
	   
	   /* fastAttack */
	   if(this.getFastAttack() != otherPokemon.getFastAttack()) {
		   return this.getFastAttack().compareTo(otherPokemon.getFastAttack());
	   }
	   
	   
	   /* specialAttack */
	   if(this.getSpecialAttack() != otherPokemon.getSpecialAttack()) {
		   return this.getSpecialAttack().compareTo(otherPokemon.getSpecialAttack());
	   }
   ...
   /**
    * Is this Pokemon equal to another?
    */
   public boolean equals(Pokemon otherPokemon) {
	   boolean number = this.getNumber() == otherPokemon.getNumber();
	   boolean name = this.getName() == otherPokemon.getName();
	   boolean hP = this.getHP() == otherPokemon.getHP();
	   boolean cP = this.getCP() == otherPokemon.getCP();
	   boolean fastAttack = this.getFastAttack() == otherPokemon.getFastAttack();
	   boolean specialAttack = this.getSpecialAttack() == otherPokemon.getSpecialAttack();
